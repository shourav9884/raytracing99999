...
protected:
	virtual Vector3D getNormalVector( const Vector3D& aPoint, Vector2D aTextureUVCoordinates ) = 0;

	virtual Vector2D getTextureUVCoordinates( const Vector3D& aIntersectionPoint) = 0;
